...
- Тому що без тебе я просто ://`,
  ...
  {
    joke: `– Син хоче стати програмістом. Як йому пояснити, що бути сантехніком набагато краще? <br>
- Адже м'яко кажучи, сруть усі, і юристи, і програмісти, і потреба в ремонті та обслуговуванні унітазів буде завжди. Я не правий?`,
  },
  {
    joke: `– Люди, які програми пишуть, тестують їх, підтримують – у мене до вас одне запитання: Як ви кукухою  не їдете? <br>
- Ми нікуди не їдемо, з дому працюємо!`,
  },
  {
    joke: `Тільки для верстальника фраза "пішло-поїхало" не означає нічого хорошого.`,
  },
  {
    joke: `- Ти мав яблуко, тобі дали ще одне. Скільки у тебе яблук? <br>
- Одне яблуко. Тому що яблуко + одне = одне яблуко. <br>
- Твоя рідна мова - це джава скрипт чи що?!`,
  },
  {
    joke: `Чому айтішників запитують, ким вони бачать себе через 5 років, якщо за фактом вони не можуть спланувати двотижневий спринт.`,
  },
  {
    joke: `До добрих програмістів на Новий рік приходить Дід Мороз. А до поганих – Дед Лайн.`,
  },
  {
    joke: `Не турбуйтеся, якщо щось не працює. Якби все працювало, вас звільнили б.`,
  },
  {
    joke: `Хлопчик хоче подобатися всім дівчатам.
Чоловік хоче подобатися всім ейчарам.`,
  },
  {
    joke: `Звернув увагу, що очі зовсім не втомлюються від робочого монітора, якщо збільшити відстань від нього до 3,5 тис кілометрів`,
  },
  {
    joke: `Якщо людині нашого покоління відрубати голову, вона ще тридцять хвилин буде саморозвиватися.`,
  },
  {
    joke: `Я досі не можу усвідомити, що я доросла людина. Мене викликають на зідзвони, дейли тощо. На них я відчуваю себе дитиною, яка потрапила випадково на батьківські збори. Вони говорять про архітектуру і т.д., а я нічого не розумію, у моїх мізках лише бажання бити кропиву.`,
  },
  {
    joke: `- Івановичу, приходь до нас назад, нам програміст потрібен. <br>
    - Так у вас же мавпа з GPT-3 є. <br>
    - Мавпа з GPT-3 вже тимлідом стала, нам знову програміст потрібний.`,
  },
  {
    joke: `- Скоро отримаємо відповідь від замовника і правитимемо! <br>
    - Світом? <br>
    - Ні, Олеже. Макет.`,
  },
  {
    joke: `У німецькій мові є слово "Verschlimmbessern", що означає "зробити щось гірше, поки ремонтуєш це".
    Українською ми називаємо це "розробник програмного забезпечення".`,
  },
  {
    joke: `Підходить Петро до Василя Івановича і питає: <br>
    -  Василь Іванович, що таке нюанс? <br>
    Василь Іванович і каже: <br>
    - Відкривай гітлаб Петро. <br>
    Петро відкрив гітлаб... <br>
    Василь Іванович бере ноутбук і дістає свій MR на 3000 рядків. <br>
    Ось дивись Петро в тебе код ревью і в мене код-рев'ю. Але є один нюанс!`,
  },
  {
    joke: `Ось бувають такі квартири, в яких взимку дуже холодно, а влітку дуже спекотно. І жодними інструментами це не виправиш. 
    Ось так і з Java чи C#. Для простих додатків вони надто складні, для складних – надто тупі. І як не намагайся це покращити – буде лише гірше.
    <br>
    Ось так і з програмістами. Для простих додатків вони надто складні, для складних – надто тупі.`,
  },
  {
    joke: `Сервіс: ось безкоштовна підписка. <br>
    Я: дякую. <br>
    Сервіс: введи номер картки. <br>
    Я: навіщо? <br>
    Сервіс ну треба.`,
  },
  {
    joke: `- Я виконаю три ваші бажання. Але ж дуже погано. <br>
    - А ти хто? <br>
    – Джун. <br>
    Відмінний коментар! <br>
    - Я виконаю три ваші бажання. Але дуже довго, дорого і лише одне бажання. <br>
    - Чого? Ти хто взагалі? <br>
    - Сеньйор.`,
  },
  {
    joke: `Якщо людині нашого покоління відрубати голову, вона ще тридцять хвилин буде саморозвиватися.`,
  ...
  {
    joke: `Мені цей код вже абсолютно зрозумілий, і я в ньому шукаю лише одного - спокою, умиротворення і ось цієї гармонії від злиття без конфліктів.`,
  },
  {
    joke: `Гра "Таємний Санта" для програмістів. Кожен розробник анонімно залишає баг у коді свого колеги.`,
  },
  {
    joke: `- Ти не міг би мені перевстановити вінду? <br>
    - Ну, ти даєш. Ти ноутбук купила кілька днів тому. У тебе там і так нова вінда. <br>
    - Ти тупий чи що? Натяків не розумієш? <br>
    - Які ще натяки? На що? Вінду запорола за пару днів ти, а тупий я?`,
  },
  {
    joke: `- Загалом, ось такий проєкт, але треба зробити за два тижні. <br>
    - Такі проєкти робляться мінімум за місяць. <br>
    - У мене лише два тижні. Вкладетеся? <br>
    - Нууу, якщо напружимо всі сили, то вкладемося. Але це коштуватиме втричі дорожче. <br>
    - З чого це раптом?! Ви ж менше часу на роботу витратите.`,
  },
  {
    joke: `Піти на побачення з гуманітарієм привабливо, бо він може, наприклад, сказати: "Я думав про тебе, коли писав цю пісню". А що запропонує технар? Назвати на честь вас git-гілку?`,
  },
  {
    joke: `Я точно не вказуватиму своїм дітям яку професію обирати. <br>
    Нехай вибирають ту мову програмування, яку захочуть.`,
  },
  {
    joke: `- Бро, навіщо використовується ctrl+z? Для скасування дії, так? <br>
    - Ні, насправді це треба, щоб після того, як тебе відволікли, згадати, де ти писав код. <br>
    - А... Дякую.`,
  },
  {
    joke: `Вчені розповіли, що скоро у роботів буде м'яка, розтяжна шкіра. Вчені не сказали, де її візьмуть роботи.
    Але ти знаєш. <br>

    Завжди знав.`,
  },
  {
    joke: `Одного разу я написав своїй коханій лист із зізнанням, але вона нічого не зрозуміла. <br>
    Може й не варто було писати його на JavaScript.`,
  },
  {
    joke: `Купила сосиски, які готуються у мікрохвильовій печі 1 хвилину. Чоловік поклав 6 штук та поставив на 6 хвилин (для кожної по одній хвилині!). Чоловікові 39 років. Я втомилася від нього.`,
  },
  {
    joke: `Вчора осяяло: коли у поліклініці люди сидять у черзі і знають тільки за ким вони йдуть – це зв'язковий список. А якщо людина знає ще, хто після неї зайняв місце, то це вже двозв'язковий список. <br>
    Виняток – це бабусі. Бабулі у черзі, звичайно, зберігають у пам'яті весь масив, через бабусю можна звернутися до будь-якого елементу.`,
  },  
];
