let quotes = [
  ...
  {
    quote:
      "Найкращий метод, щоб почати щось робити – перестати говорити і почати робити.",
    source: "Волт Дісней",
  },
  {
    quote:
      "Ваш мозок може абсолютно все. Потрібно лише переконати себе в цьому. Руки не усвідомлюють, що вони не вміють відтискатись, ноги не усвідомлюють, що вони невитривалі. Це знає мозок. Якщо ви переконаєте себе, що ви можете все, ви дійсно все зможете.",
    source: "Роберт Кіосакі",
  },
  {
    quote:
  ...
  {
    quote:
      "Потрібно вірити в себе та свої здібності! Без раціональної впевненості у своїх силах, неможливо бути успішним та щасливим.",
    source: "Норман Вінсент Піл",
  },
  {
    quote: "Ми не знаємо, ким ми можемо бути, ми лише знаємо, хто ми є.",
    source: "Вільям Шекспір",
  },
  {
    quote:
      "Удосконалення – це зміни, бути досконалим – означає змінюватися постійно.",
    source: "Вінстон Черчилль",
  },
  {
    quote: "Розум ніколи не вичерпується, навчаючись.",
    source: "Леонардо да Вінчі",
  },
  {
    quote: "Прагніть цінностей успіху, а не самого успіху.",
    source: "Альберт Ейнштейн",
  },
  {
    quote:
      "Через 20 років ви будете більше розчаровані тим, що не зробили, ніж тим, що зробили. Тому відпливайте від тихої пристані. Відчуйте попутний вітер у вітрилі. Рухайтеся вперед, дійте, відкривайте!",
    source: "Марк Твен",
  },
  {
    quote:
      "Кажуть, що мотивації вистачає ненадовго. Але те ж саме відбувається і з душем, тому й слід його приймати щодня.",
    source: "Зіг Зіглар",
  },
  {
    quote:
      "Самі по собі ідеї цінні, але будь-яка ідея, врешті-решт, — тільки ідея. Завдання в тому, що б реалізувати її практично.",
    source: "Генрі Форд",
  },
  {
    quote:
      "Людина вмирає тоді, коли перестає розвиватися, а похорон — просто формальність.",
    source: "Генрі Форд",
  },
  {
    quote:
      "Успішні люди вириваються вперед, використовуючи той час, котрий інші використовують даремно.",
    source: "Генрі Форд",
  },
  {
    quote:
      "Мій секрет успіху полягає у вмінні зрозуміти точку зору іншої людини і дивитися на речі з його, і зі своєї точки зору.",
    source: "Генрі Форд",
  },
  {
    quote:
  ...
  {
    quote: "Наші невдачі повчальніше наших успіхів.",
    source: "Генрі Форд",
  },
  {
    quote:
      "Не важливо, що ви думаєте – чи можете ви чи ні – все одно ви праві.",
    source: "Генрі Форд",
  },
  {
    quote:
      "Кожен, хто перестає вчитися, старіє, – неважливо, 20 або 80 років, – а будь-який інший, хто продовжує вчитися, залишається молодим. Найголовніше в житті – це зберегти мозок молодим.",
    source: "Генрі Форд",
  },
  {
    quote:
