const reviews = [
  ...
  },
  {
    ...
    review: "Вау, дуже крута і ідея, і робота💫",
  },
  {
    name: "Mariia Lytvyn",
    position: "Frontend Developer",
  ...
  },
  {
    ...
    review: "Дуже крута ідея! Молодці)",
  },
  {
  ...
  },
  {
    ...
    review: "Круто! Сайт чіпляє. Додав до вкладок 😉 ",
  },
  {
    name: "Nadiia Bila",
    position: "Data analyst",
    photo: "../../images/rewievs/22.jpg",
    review: "Платформа - супер! Дякую)",
  },
  {
    name: "Sofiia Matsyshena",
    position: "Front-End Developer",
    photo: "../../images/rewievs/23.jpg",
    review: "Вау, це дуже круто! Робота й справді гідна🤌🏻",
  },
  {
    name: "Yevhenii Skubenyk",
    position: "Front-End Developer",
    photo: "../../images/rewievs/24.jpg",
    review: "Супер! Так тримати. Дуже корисний ресурс!",
  },
  {
    name: "Andrii Stepaniuk",
    position: "Managing Partner",
    photo: "../../images/rewievs/25.jpg",
    review: "Круто - так тримати!",
  },
  {
    name: "Лина Курта",
    position: "Инженер",
    photo: "../../images/rewievs/26.jpg",
    review: "Наші вітання..! Успіхів ! 🤝✊💙💛🇺🇦",
  },
  {
    name: "Pavló Valor",
  ...
  {
    name: "Iryna Fedunyshy",
    position: "UI/UX Designer",
    photo: "../../images/rewievs/34.jpg",
    review: "Просто дякую 💙💛",
  },
  {
    name: "Serhii Smilichenko",
    position: "Frontend Developer",
    photo: "../../images/rewievs/35.jpg",
    review: "Cool!",
  },
  {
    name: "Anastasia Pirogova",
    position: "Junior Front-end Developer",
    photo: "../../images/rewievs/36.jpg",
    review: "Круто!",
  },
  {
    name: "Gleb Erofteev",
    position: "Front-end developer",
    photo: "../../images/rewievs/37.jpg",
    review:
      "Дякую, дуже круто, що українського контенту стає все більше! Пишаюся 💛 💙 ",
  },
  {
    name: "Rostyslav Bahniuk",
    position: "Accountant",
    photo: "../../images/rewievs/38.jpg",
    review:
      "Це МЕГА круто зібрати український контент в одному місці. Успіхів Вам!",
  },
  {
    name: "Sofiia Nikolenko",
    position: "Frontend Developer (Junior)",
    photo: "../../images/rewievs/39.jpg",
    review: "Дякую за таку круту платформу 👏",
  },
  {
    name: "Yaroslav Velichko",
    position: "Junior Frontend Developer",
    photo: "../../images/rewievs/40.jpg",
    review: "Дуже корисно) дякую)",
  },
  {
    name: "Olena Bieletska",
    position: "Frontend Developer",
    photo: "../../images/rewievs/41.jpg",
    review: "🔥 саме те, що шукала, дякую☺️",
  },
  {
    name: "Igor Aniskevich",
    position: "Front-End engineer",
    photo: "../../images/rewievs/42.jpg",
    review: "Дякую!!",
  },
  {
    name: "Iryna Vyshnia",
    position: "Junior QA Engineer",
    photo: "../../images/rewievs/43.jpg",
    review: "Круто)",
  },
  {
    name: "Anton Bukin",
    position: "Trainee Front-end Developer",
    photo: "../../images/rewievs/44.jpg",
    review: "Клас, дуже подобаються уроки від Савчука)",
  },
  {
    name: "Vira Mesha",
    position: "Front-end developer",
    photo: "../../images/rewievs/45.jpg",
    review: "Класні ресурси для верстки, неодмінно буду користуватися😊 ",
  },
  {
    name: "Давид Карапетян",
    position: "Shopify Developer",
    photo: "../../images/rewievs/46.jpg",
    review: "Це скарб!)))",
  },
  // {
  //   name: "ІМЯ",
